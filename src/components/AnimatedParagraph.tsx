...
export default function AnimatedParagraph({ paragraph }: ParagraphProps) {
  ...
  return (
    <div
      ref={container}
      className={`text-3xl md:text-4xl lg:text-5xl max-w-4xl mx-auto mb-12 leading-relaxed min-h-[300px] py-12 will-change-transform  transition-colors duration-500 ${
