      ...
      <div>
        ...
        <div className="flex flex-wrap gap-4">
          <label className="relative flex items-center group">
            ...
            />
            <div className="px-6 py-3 rounded-xl bg-white/5 border border-white/10 peer-checked:bg-primary/20 peer-checked:border-primary/30 backdrop-blur-sm transition-all duration-150 cursor-pointer hover:bg-white/10 hover:border-white/20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          {STORY_CATEGORIES.map((category) => (
            <label key={category} className="relative flex items-center group">
              ...
              />
              <div
                className={`w-full px-4 py-3 rounded-xl backdrop-blur-sm transition-all duration-150 cursor-pointer text-center ${
