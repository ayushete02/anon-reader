    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex justify-center items-center">
        <div className="text-center">
          ...
          <p className="text-white text-lg">Discovering amazing stories...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 pt-8 pb-20">
        {/* Quick Stats Bar */}
        <div className="mb-8">
          <div className="bg-gray-900/30 backdrop-blur-xl rounded-2xl border border-gray-800/50 p-4">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            <h3 className="text-lg font-semibold text-white">Quick Browse</h3>
            <svg
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {allCategories.length > 6 && (
              <button className="px-4 py-2 bg-gray-800/30 text-gray-400 rounded-xl text-sm font-medium border border-gray-700 hover:border-gray-600 transition-all duration-300">
          ...
          <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl border border-gray-800/50 p-6 shadow-2xl">
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent transition-all duration-300"
                  />
                  {searchQuery && (
                    <button
            ...
            {(searchQuery || selectedCategory !== "All") && (
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                {searchQuery && (
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-red-600/20 text-red-400 rounded-full text-sm border border-red-600/30">
                    Search: &quot;{searchQuery}&quot;
                    <button
                      onClick={() => setSearchQuery("")}
                ...
                {selectedCategory !== "All" && (
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-blue-600/20 text-blue-400 rounded-full text-sm border border-blue-600/30">
        ...
        {searchQuery || selectedCategory !== "All" ? (
          ...
          <div className="space-y-12">
            ...
            {personaLoaded && userPersona.personaType && (
              <div className="bg-gradient-to-r from-red-600/10 via-purple-600/10 to-red-600/10 rounded-2xl border border-red-600/20 p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  {/* Persona-based recommendation stats */}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                          ...
                          we&apos;ve selected comics that match your preferences
                          for{" "}
            ...
            {/* Fallback "For You" section for users without persona */}
            {(!personaLoaded || !userPersona.personaType) && (
            ...
            {/* Category Sections with Enhanced Headers */}
