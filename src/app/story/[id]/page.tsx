        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8 items-start">
            ...
            <div className="lg:col-span-2 flex justify-center lg:justify-start">
              <div className="relative group max-w-[300px] sm:max-w-[350px] lg:max-w-none w-full">
                {/* Glowing effect */}
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-3 right-3">
                    <div
                      className={`px-2 sm:px-3 py-1 rounded-full backdrop-blur-md border border-white/20 text-xs font-semibold ${
                        story.type === "text"
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="space-y-4 text-center lg:text-left">
                <div>
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-white via-white/90 to-white/80 bg-clip-text text-transparent leading-tight">
                    {story.title}
                  </h1>
                </div>
                {/* Stats */}
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-3 text-white/80">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-2">
                  {story.categories.map((category, index) => (
                    <span
                      key={category}
                      className={`px-2 sm:px-3 py-1 rounded-full text-xs font-medium backdrop-blur-sm border border-white/20 transition-all duration-300 ${
                        index % 3 === 0
              ...
              <div className="space-y-3">
                ...
                <div className="morphic-glass rounded-lg p-4 border border-white/10 shadow-glossy">
                  <p className="text-white/90 leading-relaxed text-sm text-center lg:text-left">
                    {story.description}
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h8m-9 5h10a2 2 0 002-2V7a2 2 0 00-2 2v10a2 2 0 002 2z"
                    />
                  </svg>
