      ...
      {step === "email" && (
        ...
        >
          <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-white/5 bg-white/5 text-white focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent text-base transition-all duration-150 backdrop-blur-sm"
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
          <div className="relative">
            <input
              ...
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className={`w-full px-4 py-3 rounded-xl border border-white/5 bg-white/5 text-white text-base pr-10 backdrop-blur-sm ${
                isEditingEmail
